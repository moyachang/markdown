...
## 前言:
延續上次介紹過的 DDD 與 Clean Architecture，未來 UP4 的專案架構也會遵循這個模式開發。

「這樣做的好處是，未來如果我們要更換資料庫或升級框架，核心業務邏輯（Domain）完全不需要改動，能大幅降低維護成本。」

## 專案架構遵循 DDD + Clean Architecture 分層架構
基本上是使用 Clean Architecture，但有些調整是跟六邊型架構較相似，所以嚴格來說算是混合架構。

如下圖所示，整個架構分為四個層次。最核心的原則是『依賴規則』。
外層可以依賴內層，但內層（也就是我們的 Domain 層）必須保持單純，絕對不能依賴任何外層實作。
<font color="red">⚠ 依賴方向規則： 外層可依賴內層，  內層（Domain） 不可依賴外層</font>
>
><font color="red">**方向性如下**</font>
**Presentation → Application → Domain
Infrastructure 則是實作 Domain 的介面（依賴反轉）**
👉 不要直接依賴具體做法，要依賴共同規則，這就是 [依賴反轉]（Dependency Inversion Principle, DIP) 的核心。
...
[![](http://hedgedoc.flowring.com/uploads/5f30fd58-d49d-40e1-ba1d-98243336ec0b.png)](http://hedgedoc.flowring.com/uploads/5f30fd58-d49d-40e1-ba1d-98243336ec0b.png "點我放大")


### <font color="blue">**(一) Presentation Layer**</font>
...
[![](http://hedgedoc.flowring.com/uploads/03787afc-60d6-433e-bd97-4f42f9417b61.svg)](http://hedgedoc.flowring.com/uploads/03787afc-60d6-433e-bd97-4f42f9417b61.svg "點我放大")
...
<font color="blue">資料傳輸物件—DTO 讓 API 契約穩定，即使內部 Model 改變也不影響外部介面。</font>
        ...
        - 命名上，如果是 web 專用的 DTO，命名上可以用 "XXXXXRestRequest" 或者是 "XXXXXWebRequest", 避免與 gRPC 的 DTO 搞混。
        -  <font color="green">**request/**</font>: 定義 Client 傳入的欄位與型別，通常搭配驗證註解。 (如 @NotNull、@Valid)
            ```java= 
...
- 核心職責概覽
[![](http://hedgedoc.flowring.com/uploads/8cc6547b-5ffa-4303-95a5-b8278566f9d6.svg)](http://hedgedoc.flowring.com/uploads/8cc6547b-5ffa-4303-95a5-b8278566f9d6.svg "點我放大")
...
- 核心職責概覽
[![](http://hedgedoc.flowring.com/uploads/c8f77876-dcc7-4336-bbec-eadf5f58221b.png)](http://hedgedoc.flowring.com/uploads/c8f77876-dcc7-4336-bbec-eadf5f58221b.png "點我放大")
...
---
- 核心職責概覽:
[![](http://hedgedoc.flowring.com/uploads/1212f450-13b0-4345-910f-3229557978d4.svg)](http://hedgedoc.flowring.com/uploads/1212f450-13b0-4345-910f-3229557978d4.svg "點我放大")
